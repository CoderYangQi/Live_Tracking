...
class RealTimeDetectionApp(QMainWindow):
    ...
    def initModel(self):
        ...
        configPath =  r'F:\yq\code\1123dlc-models\dlc-models\iteration-0\RealMiceNov22-trainset95shuffle1\test\pose_cfg.yaml'
        # weightPath =  r"E:\yq\code\DataAndModel\\dlc-models\\iteration-0\\Test2Jul27-trainset95shuffle1\\train\\snapshot-100000"
        weightPath =  r"F:\yq\code\1123dlc-models\dlc-models\iteration-0\RealMiceNov22-trainset95shuffle1\train\snapshot-50000"
