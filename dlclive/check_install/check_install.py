...
def main():
    ...
    # D:\USERS\yq\code\MotionTracking\DLC_Live\check_install_dog_clip.avi
    ...
    if Path(model_dir / SNAPSHOT_NAME).exists():
        ...
        # from download import yq_download_huggingface_model
        # yq_download_huggingface_model(MODEL_NAME, model_dir)
